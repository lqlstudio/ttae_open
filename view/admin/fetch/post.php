  ...
  <tr class="noborder">
      ...
      <tr class="noborder">
          ...
          <td class="vtop rowform" >         
			...
			<span class="select_cates_sub">
            {if $_GET.id>0 && $fetch.cid>0}
             <select name="postdb[cid]"  class="select">
                <option value="">----不限----</option>
                 <!--{foreach from=$cates item=vv}-->
                 {foreach from=$vv.sub item=d}
                <option value="{$d.cid}"  {if $fetch.cid==$d.cid } selected{/if} >{$d.name} </option>
                {/foreach}
                <!--{/foreach}-->
                </select>
            {/if}
     ...
     <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="td_l">排序</td>
          <td class="vtop rowform" ><select name="postdb[sort]"  class="select" data-value="{$fetch.sort}" >
...
<!--              <option value="commission_num_desc">成交量成高到低</option>
        ...
        <tr class="noborder">
          ...
          <td class="vtop rowform" ><select name="postdb[startcredit]"   style="width:120px;"  data-value="{$fetch.startcredit}">
              <option value="">----不限----</option>
            ...
            &nbsp;--&nbsp;
            <select name="postdb[endcredit]"   style="width:120px;" data-value="{$fetch.endcredit}">
              <option value="">----不限----</option>
              <option value="1heart">一心</option>
              <option value="2heart ">二心</option>
              <option value="3heart ">三心</option>
       ...
       <!-- <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <td class="vtop rowform" ><input name="postdb[page_size]" value="{if $fetch.page_size}{$fetch.page_size}{else}40{/if}" type="text" class="txt" ></td>
          <td class="vtop tips2">可空,淘宝客接口最大每页40,百川接口最大每页100</td>
        </tr>
