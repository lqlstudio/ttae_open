...
<form enctype="multipart/form-data" method="post" action="{$URL}m=goods&a=main">
  ...
  <div class="table_main">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="vtop rowform">
                  ...
                  <option value="city">商品所在省份</option>
                  <option value="state">商品所在市区</option>          
                  <option value="message">商品详情</option>          
                  <option value="yh_name">优惠名称</option>          
                  <option value="apply_user">联系人姓名</option>          
                  <option value="apply_wangwang">联系旺旺</option>          
                  <option value="apply_phone">联系人电话</option>          
          </select>
          </td>
    ...
    <tr class="noborder">
         ...
         <tr>
          <td colspan="2" class="td27" >佣金范围:</td>
        </tr>
        <tr class="noborder">
          <td class="vtop rowform">
          <input name="commission_down" value=""  type="text" class="txt w90"> %
           - 
          <input name="commission_up" value=""  type="text" class="txt w90"> %
          </td>
          <td class="vtop tips2" >要搜索的商品佣金范围</td>
        </tr>
