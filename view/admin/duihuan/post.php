     ...
     <tr class="noborder" >
       ...
       <tr class="noborder">
          ...
          <select name="postdb[cate]">
            ...
            <option value="{$k}" {if $goods.tag==$k} selected="selected"{/if} >{$vv.name}</option>
            <!--{/foreach}-->
          </select>
            </td>
...
<input type="file" name="file" class="J_TCajaUploadImg upload_file_btn" data-url="/upload.php" />
        ...
        <tr class="noborder" >
          ...
          <td class="vtop rowform"><input name="postdb[start_time]" value="{if $goods.org_start_time>0}{$goods.start_time}{/if}" type="text" class="txt _dateline"></td>
      ...
      <tr class="noborder" >
          ...
          <td class="vtop rowform"><input name="postdb[end_time]" value="{if $goods.org_end_time>0}{$goods.end_time}{/if}" type="text" class="txt _dateline"></td>
