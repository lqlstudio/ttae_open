...
<!--          <p>  优站本地,如果当前程序在优站上必须选择. 优站远程,如果空间是在外站,可以选择</p>
		 ...
		 <tr class="noborder">
          ...
          <td class="vtop rowform"><input class="txt" type="text" name="postdb[cate_page]" value="{$_G.setting.cate_page}" /></td>
	 ...
	 <tr class="noborder">
        ...
        <tr class="noborder">
         ...
         <tr class="noborder">
          ...
          <td class="vtop rowform"><input class="radio" type="radio" name="postdb[show_goods]" value="1" {if $_G.setting.show_goods==1}checked="checked"{/if}>
            &nbsp;是
            <input class="radio" type="radio" name="postdb[show_goods]" value="0" {if $_G.setting.show_goods==0}checked="checked"{/if}>
            &nbsp;否 </td>
