    ...
    <table class="tb tb2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
         ...
         <tr>
          <td colspan="2" class="td27" >上次积分范围:</td>
        </tr>
        <tr class="noborder">
          <td class="vtop rowform">
          <input name="jf_down" value=""  type="text" class="txt w90">
           - 
          <input name="jf_up" value=""  type="text" class="txt w90">
          
          </td>
          <td class="vtop tips2" >要搜索的积分范围</td>
        </tr>
