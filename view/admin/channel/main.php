...
<!--{/foreach}-->
        ...
        <td class="td28"><a href="{$URL}&a=post&fid={$v.fid}">编辑</a>&nbsp; <a href="{$URL}&a=del&fid={$v.fid}">删除</a></td>
        <td class="td28"> <a href="{$URL}&a=clear&fid={$v.fid}">清空商品({$v.count})</a></td>
      </tr>
      </tbody>
...
{if $v.sub}
        ...
        <tr class="hover" >
         ...
         <td class="td28"> <input type="text" name="url[{$v1.fid}]" value="{$v1.org_url}"></td>
          ...
          <td><a href="{$URL}&a=post&fid={$v1.fid}">编辑</a>&nbsp; 
          <a href="{$URL}&a=del&fid={$v1.fid}"  class="_confirm" data-msg="您确定要删除当前栏目吗?删除后不可恢复">删除</a></td>
          <td> <a href="{$URL}&a=clear&fid={$v1.fid}" >清空商品({$v1.count})</a></td>
        </tr>
    ...
    <tbody>
        ...
        <tr class="hover" >
         ...
         <td class="td28"> <input type="text" name="url[{$a1.fid}]" value="{$a1.org_url}"></td>
          ...
          <td><a href="{$URL}&a=post&fid={$a1.fid}">编辑</a>&nbsp; 
          <a href="{$URL}&a=del&fid={$a1.fid}" >删除</a></td>
          <td><a href="{$URL}&a=clear&fid={$a1.fid}" >清空商品({$a1.count})</a></td>
        </tr>
        <!--{/foreach}-->
    </tbody>
