    ...
    <table class="tb tb2 nobdb">
      ...
      <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <td class="vtop rowform"><input name="postdb[email]" value="{$member.email}" type="text" class="txt">
         ...
         <tr class="noborder">
          ...
          <td class="vtop rowform"><input name="password" value="" type="password" class="txt"></td>
          <td class="vtop tips2">U站的不用理,只适用于站外的,不修改请留空</td>
        </tr>

         <tr class="noborder">
          <td class="td_l">账户余额:</td>
          <td class="vtop rowform"><input name="postdb[money]" value="{$member.money}" type="text" class="txt"></td>
...
{/if}
        ...
        <tr class="noborder">
          ...
          <td class="vtop rowform"><input name="postdb[regdate]" value="{$member.regdate}"  readonly   type="text" class="txt "  style="background:#ddd;"></td>
          <td class="vtop tips2">禁止修改</td>
        </tr>
         ...
         <tr class="noborder">
          ...
          <td class="vtop rowform"><input name="postdb[login_time]" value="{$member.login_time}"  readonly  type="text" class="txt "  style="background:#ddd;"></td>
          <td class="vtop tips2">禁止修改</td>
        </tr>
        ...
        <tr class="noborder">
         ...
         <tr class="noborder">
          ...
          {if $_G.setting.fanli ==1 }
            <tr class="noborder">
          <td class="td_l">所属推广组:</td>
          <td class="vtop rowform"><select name="postdb[rank]" class="select">
            <option value="">---请选择推广组---</option>
              <!--{foreach from=$_G.rank item=vv}-->
              <option value="{$vv.id}" {if $member.rank==$vv.id} selected="selected" class="on"  {/if}>{$vv.name}</option>
              <!--{/foreach}-->
            </select></td>
          <td class="vtop tips2"></td>
          {/if}
