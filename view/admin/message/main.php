...
<li {if  $_GET.check ==1}class="on"{/if}><a href="{$URL}m=message&a={$CA}&check=1"><span>已阅</span></a></li>
<li {if  $_GET.check =='0'}class="on"{/if}><a href="{$URL}m=message&a={$CA}&check=0"><span>未阅</span></a></li>
<li {if  $_GET.check ==2}class="on"{/if}><a href="{$URL}m=message&a={$CA}&check=2"><span>待阅</span></a></li>
