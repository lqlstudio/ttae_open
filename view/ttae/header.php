...
<li {if $_GET.price=='20_30'}class="hpzmenusel"{/if}><a class="is_color is_bold" href="{$URL}a=all&price=20_30">29.9包邮</a></li>
<li {if $_GET.price=='30_40'}class="hpzmenusel"{/if}><a class="is_color is_bold" href="{$URL}a=all&price=30_40">39.9包邮</a></li>


<!--<li {if $CURMODULE == 'shop'}class="hpzmenusel"{/if}><a class="is_color is_bold" href="{$URL}m=shop&a=shop_list">品牌团</a></li>-->
<!--<li {if $CURMODULE == 'activity'}class="hpzmenusel"{/if}><a class="is_color is_bold" href="{$URL}m=activity">全网大促</a></li>-->
...
<div class="score_nav cl">
    <ul class="score_nav_ul">
        ...
        <span class="y">
         <li><a href="{$URL}m=list&a=main{if $_G.fid}&fid={$_G.fid}{/if}{if $_G.id}&id={$_G.id}{/if}" style="{if !$_GET.order}color:#E32014;{/if}">默认</a></li>
         <li>
         <a href="{$URL}m=list&a=main{if $_G.fid}&fid={$_G.fid}{/if}{if $_G.id}&id={$_G.id}{/if}&order=yh_price&sort=asc" style="{if $_GET.order == 'yh_price' }color:#E32014;{/if}">价格</a>
         </li>
		{/if}
