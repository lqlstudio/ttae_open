...
<li class="uc_zlli1">
  ...
  <input class="uinfo uc_zlli1text text" name="postdb[sum]" type="text" value="{$goods.sum}">
   ...
   <li class="uc_zlli1">
   <label>上线时间段：</label>
  <input class="uinfo uc_zlli1text text dateline" name="postdb[start_time]" type="text" value="{$goods.start_time}">
</li> 
 
</li>
<li class="uc_zlli1">
  <label>下线时间段：</label>
  <input class="uinfo uc_zlli1text text dateline" name="postdb[end_time]"  type="text" value="{$goods.end_time}">
  <h2></h2>
</li>
  <li class="uc_zlli1">
  <label>佣金：</label>
