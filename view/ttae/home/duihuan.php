...
<ul class="uc_scoredtab" {if $k%2==1}style="background-color: rgb(245, 245, 245);"{/if}>
            ...
            <li class="uc_scoreli4"  style="width:80px">{$v.sum}</li>

             <li class="uc_scoreli4"  style="width:80px"><i style="color: #e32014">{$v.num}</i></li>

             <li class="uc_scoreli2"  style="width:100px">{$v.status_text}</li>
