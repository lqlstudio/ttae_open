...
<div class="shop_desc wp cl" style=" margin-top: 20px; ">
            ...
            <div class="ppTitle area">
                <div class="ppLogo" >
                  <span><a target="_blank" href="{$shop.id_url}"  isconvert="1"><img src="{$shop.pic_path}" alt="{$shop.name}"></a></span>
                </div>
                <div class="ppName">
                  ...
                  <div class="ppInfor">                    
                      ...
                      <span>
                            <a target="_blank" href="{$shop.id_url}"  isconvert="1">{$shop.title}卖专场<b>{$shop.zk}</b>折起 &gt; </a>
