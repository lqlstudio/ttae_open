...
<!--{/foreach}-->
        ...
        <tr class="noborder hide" >
          ...
          <td class="vtop rowform"><select name="postdb[cate]">
              ...
              <option value="{$vv.id}" {if $goods.cate==$vv.id} selected="selected"{/if} >{$vv.name}</option>
        ...
        <tr class="noborder" style="display:none;" >
          ...
          <td class="vtop rowform"><input name="postdb[cid]" value="{$goods.cid}" type="text" class="txt" {$readonly}></td>
...
<input type="file" name="file" class="J_TCajaUploadImg upload_file_btn" data-url="/upload.php" />  
        ...
        <tr class="noborder" style="display:none;" >
          ...
          <td class="vtop rowform"><input  name="postdb[nick]" value="{$goods.nick}" type="text" class="txt"{$readonly} ></td>
        ...
        <tr class="noborder" style="display:none;">
          ...
          <td class="vtop rowform"><input  name="postdb[url]" value="{$goods.url}" type="text" class="txt" {$readonly}></td>
        ...
        <tr class="noborder" >
          ...
          <td class="vtop rowform"><input  name="postdb[num]" value="{$goods.num}" type="text" class="txt" {$readonly}></td>
        ...
        <tr class="noborder hide" >
          ...
          <td class="vtop rowform"><input  name="postdb[start_time]" value="{$goods.start_time}" type="text" class="txt dateline" ></td>
        ...
        <tr class="noborder hide" >
          ...
          <td class="vtop rowform"><input  name="postdb[end_time]" value="{$goods.end_time}" type="text" class="txt dateline" ></td>
       ...
       <tr class="td_l noborder" >
        ...
        <tr class="noborder" >
         ...
         <tr class="noborder" >
          ...
          <td class="vtop rowform"><input name="postdb[commission]" value="{$goods.commission}" type="text" class="txt"></td>
        ...
        <tr>
          ...
          <td colspan="5"><div class="fixsel"> {if $_G.setting.show_goods}

              <div class="hide">

                <textarea rows="6" name="postdb[message]" cols="70" class="ks-editor-textarea">{$goods.message}</textarea>
...
<input name="postdb[commission]" value="{$goods.commission}" type="hidden" class="txt">
