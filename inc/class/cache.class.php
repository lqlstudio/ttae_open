	...
	public function update($cachename) {
		...
		switch($cachename){
			...
			case 'setting':
									...
									if($setting['shiyong_status']) $setting['shiyong_status']  = explode(',',$setting['shiyong_status']);
									if($setting['duihuan_status']) $setting['duihuan_status']  = explode(',',$setting['duihuan_status']);
									if($setting['shiyong_tags']) $setting['shiyong_tags']  = explode(',',$setting['shiyong_tags']);
									if($setting['activity_tags']) $setting['activity_tags']  = explode(',',$setting['activity_tags']);
									if($setting['style_tags']) $setting['style_tags']  = explode(',',$setting['style_tags']);
