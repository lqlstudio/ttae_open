<?php /* Smarty version Smarty-3.1.15, created on 2015-09-21 00:59:54
         compiled from "C:\TAE_SDK\apps\TTAE\v4_0\view\ttae\header.php" */ ?>
<?php /*%%SmartyHeaderCode:731855fd8082e68d88-54482804%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61449601b34b212dd2b37cf54355fe79f2dee1c2' => 
    array (
      0 => 'C:\\TAE_SDK\\apps\\TTAE\\v4_0\\view\\ttae\\header.php',
      1 => 1442768332,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '731855fd8082e68d88-54482804',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_55fd808317c3d1_06418590',
  'variables' => 
  array (
    'CSSDIR' => 0,
    'today' => 0,
...
<?php if ($_valid && !is_callable('content_55fd808317c3d1_06418590')) {function content_55fd808317c3d1_06418590($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../common/header.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<li <?php if ($_smarty_tpl->tpl_vars['_GET']->value['price']=='20_30') {?>class="hpzmenusel"<?php }?>><a class="is_color is_bold" href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
a=all&price=20_30">29.9包邮</a></li>
<li <?php if ($_smarty_tpl->tpl_vars['_GET']->value['price']=='30_40') {?>class="hpzmenusel"<?php }?>><a class="is_color is_bold" href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
a=all&price=30_40">39.9包邮</a></li>
...
m=shop&a=shop_list">品牌团</a></li>-->
<!--<li <?php if ($_smarty_tpl->tpl_vars['CURMODULE']->value=='activity') {?>class="hpzmenusel"<?php }?>><a class="is_color is_bold" href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
m=activity">全网大促</a></li>-->
...
" <?php if ($_smarty_tpl->tpl_vars['CA']->value=='cate'&&$_smarty_tpl->tpl_vars['_G']->value['id']==$_smarty_tpl->tpl_vars['v']->value['id']) {?>style="color:#E32014;"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
        ...
        <span class="y">
         <li><a href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
m=list&a=main<?php if ($_smarty_tpl->tpl_vars['_G']->value['fid']) {?>&fid=<?php echo $_smarty_tpl->tpl_vars['_G']->value['fid'];?>
