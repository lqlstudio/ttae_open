...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplateDir('.' . DS . 'templates' . DS)
            ->setCompileDir('.' . DS .'web'.DS . 'templates_c' . DS)
     ...
     * @param  string $type    "pre", "output", &hellip; specify the filter type to set. Defaults to none treating $filters' keys as the appropriate types
     * @return Smarty current Smarty instance for chaining
     */
     ...
     * @return array  array( 'type1' => array( 'filter1', 'filter2', &hellip; ) ) or array( 'filter1', 'filter2', &hellip;) if $type was specified
     */
