...
var config = {box:'#j_box',el:'.list-auction-box',max_list:5,
							margin:10,index:1,url:'/index.php?m=zj&a=list',page:1,callback:call};			
...
function _waterfall(config){
	...
	*/
	...
	this.run = function(){	
		...
		this.scroll_get = new _scroll_get(cfg);
		return this;
	}
	this.waterfall();
	return this;
...
function _scroll_get(config){
	...
	this.run = function(){			
			...
			_scroll(function(top,el){
				if(_this.stop) return true;
				if(_this.scroll_top>top) return true;
